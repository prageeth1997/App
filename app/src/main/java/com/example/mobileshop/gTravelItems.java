...
public class gTravelItems {
    ...
    public gTravelItems(String travelItemId, String travelItemName, String travelItemPrice, String travelItemDescription, String travelItemImage, String travelContactNumber) {
